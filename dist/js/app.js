(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".galleryslider__slider")) new core(".galleryslider__slider", {
                modules: [ Navigation, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".guides__slider")) new core(".guides__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.3,
            ...
            if (document.querySelector(".viewed__slider")) new core(".viewed__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(true && ".tour-thumbs__slider")) {
                const tourThumbsSlider = new core(".tour-thumbs__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
...
***************************************************************************** */
        ...
        document.body.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".featured__item-like")) targetElement.classList.toggle("_active");
            if (targetElement.closest(".detail-tour__wishlist")) targetElement.classList.toggle("_active");
        }));
        function menuFilter() {
            if (document.querySelector(".filter-btn")) document.addEventListener("click", (function(e) {
                if (e.target.closest(".filter-btn")) document.documentElement.classList.toggle("filter-open");
            }));
        }
        menuFilter();
        window["FLS"] = true;
